...
int32 UCrowdBakerDataAsset::GetIndexFromAnimSequence(const UAnimSequence* Sequence)
{
	...
	{
		const FCrowdBakerAnimSequenceInfo& SequenceInfo = AnimSequences[Index];
...
void UCrowdBakerDataAsset::ResetInfo()
{
	// Common Info.
	NumFrames = 0;
	Animations.Reset();
