...
#include "CrowdBakerDataAsset.generated.h"

class USkeletalMesh;
class UStaticMesh;
class UTexture2D;

namespace CrowdBakerParamNames
{
...
UENUM(Blueprintable)
enum class ECrowdBakerMode : uint8
{
...
UENUM(Blueprintable)
enum class ECrowdBakerPrecision : uint8
{
	/* 8 bits */
	EightBits,
	/* 16 bits */
...
UENUM(Blueprintable)
enum class ECrowdBakerNumBoneInfluences : uint8
{
...
struct FCrowdBakerAnimSequenceInfo
{
	GENERATED_BODY()
...
class CROWDBAKERRUNTIME_API UCrowdBakerDataAsset : public UPrimaryDataAsset
{
public:
	GENERATED_BODY()
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Texture")
	ECrowdBakerPrecision Precision = ECrowdBakerPrecision::EightBits;
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Texture")
	ECrowdBakerMode Mode = ECrowdBakerMode::Bone;

	/**
	* Texture for storing vertex positions
	* This is only used on Vertex Mode
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Texture", meta = (EditCondition = "Mode == ECrowdBakerMode::Vertex", EditConditionHides))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Texture", meta = (EditCondition = "Mode == ECrowdBakerMode::Bone", EditConditionHides))
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Animation", meta = (EditCondition = "Mode == ECrowdBakerMode::Bone"))
	...
	* This will be used by UpdateMaterialInstanceFromDataAsset and AssetActions for setting MaterialInstance static switches
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Material", meta = (EditCondition = "Mode == ECrowdBakerMode::Bone", EditConditionHides))
	ECrowdBakerNumBoneInfluences NumBoneInfluences = ECrowdBakerNumBoneInfluences::Four;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info", Meta = (EditCondition = "Mode == ECrowdBakerMode::Bone", EditConditionHides))
	int32 NumBones = 0;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info", Meta = (EditCondition = "Mode == ECrowdBakerMode::Vertex", EditConditionHides))
	int32 VertexRowsPerFrame = 1;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info", Meta = (DisplayName = "MinBBox", EditCondition = "Mode == ECrowdBakerMode::Vertex", EditConditionHides))
	FVector3f VertexMinBBox;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info", Meta = (DisplayName = "SizeBBox", EditCondition = "Mode == ECrowdBakerMode::Vertex", EditConditionHides))
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info", Meta = (DisplayName = "MinBBox", EditCondition = "Mode == ECrowdBakerMode::Bone", EditConditionHides))
	FVector3f BoneMinBBox;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info", Meta = (DisplayName = "SizeBBox", EditCondition = "Mode == ECrowdBakerMode::Bone", EditConditionHides))
	FVector3f BoneSizeBBox;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Info")
	TArray<FCrowdBakerAnimInfo> Animations;
...
#define CrowdBakerDataAsset_ASSET_ACCESSOR(ClassName, PropertyName) \
	FORCEINLINE ClassName* Get##PropertyName() const { return GetAsset(PropertyName); }

	CrowdBakerDataAsset_ASSET_ACCESSOR(UStaticMesh, StaticMesh);
	CrowdBakerDataAsset_ASSET_ACCESSOR(USkeletalMesh, SkeletalMesh);
	CrowdBakerDataAsset_ASSET_ACCESSOR(UTexture2D, VertexPositionTexture);
	CrowdBakerDataAsset_ASSET_ACCESSOR(UTexture2D, VertexNormalTexture);
	CrowdBakerDataAsset_ASSET_ACCESSOR(UTexture2D, BonePositionTexture);
	CrowdBakerDataAsset_ASSET_ACCESSOR(UTexture2D, BoneRotationTexture);
	CrowdBakerDataAsset_ASSET_ACCESSOR(UTexture2D, BoneWeightTexture);
